...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary: ` text-sm inline-block rounded-full border-2
    font-semibold uppercase text-stone-400
    tracking-wide px-4 py-2.5 md:px-6 md:py-3.5
    hover:text-stone-800 transition-colors duration-300 hover:bg-stone-200 
    focus:bg-stone-200 focus:text-stone-800 focus:outline-none 
